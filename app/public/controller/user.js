                ...
                if (mailCheck != null) { // Check mail
                    ...
                    this.model.insert(post)
                        .then(user => {
                            ...
                            this.helper.sendMail(post.email, 'Your verification code', 'Hi, <a href="https://' + global.conf.server.domain + ':' + global.conf.server.https_port + '/user/verify/' + user.id + '/' + post.verify_code + '">Click here</a> for verify your account.')
                                .then(result => {
                                    res.send({
                                        status: "OK",
                                        data: user,
